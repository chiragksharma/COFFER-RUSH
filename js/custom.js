...
function moveCar() {
    ...
    var x = Math.floor(pos / 100);

    console.log('moving-light' + x);

    if (idx % 2 == 0)
        document.getElementById('moving-light' + x).style.opacity = 1;
    else
        document.getElementById('moving-light' + x).style.opacity = 0.1;
...
//     $("#iframe").attr("src", "https://external.sprinklr.com/insights/explorer/dashboard/601b9e214c7a6b689d76f493/tab/43?id=DASHBOARD_601b9e214c7a6b689d76f493&tabId=43&home=1");
// });